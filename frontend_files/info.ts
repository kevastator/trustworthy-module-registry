...
const updatePackageButton = document.getElementById("updatePackageButton") as HTMLButtonElement;
updatePackageButton.addEventListener("click", async () => {
    const packageName = (document.getElementById("updatePackageName") as HTMLInputElement).value.trim();
...
async function fetchPackageRatings(packageID: string) {
    try {

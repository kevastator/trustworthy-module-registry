...
async function urlExtract(testurl: string, dir: string, debloat: boolean, preVersion: string)
{
...
async function contentExtract(content: string, dir: string, Name: string, debloat: boolean, preVersion: string)
{
    // Create the buffer
